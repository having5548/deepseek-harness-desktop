...
![Version](https://img.shields.io/badge/version-0.4.0-2b6cb0)
...
Double-click `artifacts/DshDesktop-Setup-0.4.0.exe` and follow the wizard — no admin rights needed.
...
- `artifacts/DshDesktop-Setup-0.4.0.exe` — installer
